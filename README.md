...
- 升级了`maven-compiler-plugin`插件版本为`3.10.1`
- `maven-compiler-plugin`默认的java版本为`1.7`，根据实际项目需要将java版本为了`1.8`
...
- 升级了`maven-surefire-plugin`插件版本为`2.22.2`
...
- 升级了`maven-deploy-plugin`插件版本为`2.8.2`
